...
CSV_PATH = "/Users/khoatran/Desktop/improvedNBA_Data.csv"
...
def main():
    ...
    #features = ['Team Win Percentage','MIN', 'PTS', 'FG_PCT', 'FG3_PCT', 'FT_PCT', 'REB', 'AST', 'STL', 'BLK', 'TOV', 'PER', 'OFFRTG', 'DEFRTG', 'NETRTG', 'AST_PCT', 'AST_TO_TO', 'AST_RATIO', 'TO_RATIO', 'EFG', 'TS', 'USG_RATE', 'WIN_SHARE', 'Salary(millions)']
